          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-md-8">
                ...
                <br/>
                <div id="players-input-error" className="alert alert-danger" role="alert" style={{display:"none"}}>
            ...
            <div className="row">
              ...
              <div className="col-md-8">
                ...
                <br/>
                <div id="team-input-error"  className="alert alert-danger" role="alert" style={{display:"none"}}>
                  Number must be between 2 and 4
                  </div>
              </div>  
            </div>
