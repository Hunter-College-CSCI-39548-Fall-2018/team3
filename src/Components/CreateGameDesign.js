...
class CreateGameDesign extends React.Component{
    constructor(props){
        super(props)
        ...
        if(this.state.redirect){
            ...
            return(
                <div id="header" className="d-flex align-items-center flex-column justify-content-center h-100 bg-dark text-white">
                    <h1 id="logo" className="display-4">Create Game</h1>
                    <div id="global-error" className="alert alert-danger" role="alert" style={{display:"none"}}>One or more inputs are bad</div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-8">
                                <div className="input-group mb-3">
                                    <div className="input-group-prepend">
                                        ...
                                        <input ref={this.players_per_team} type='tel' className="form-control" placeholder="Players per team" required={true} onChange={ (e) => {
                                    ...
                                    <br/>
                                    <div id="players-input-error" className="alert alert-danger" role="alert" style={{display:"none"}}>Number must be greater than 0</div>
                                </div>
                            </div>
                            <div className="row">
                            <div className="col-md-2">
                            ...
                            <div className="col-md-8">
                                <div className="input-group mb-3">
                                    ...
                                    <br/>
                                    <div id="team-input-error"  className="alert alert-danger" role="alert" style={{display:"none"}}>Number must be between 2 and 4</div>
                                </div>
                            </div>
                            <div className="row">
                            <div className="col-md-2">
                            ...
                            <div className="col-md-8">
                                <div className="input-group mb-3">
                                    ...
                                    <br/>
                                    <div id="icons-input-error"  className="alert alert-danger" role="alert" style={{display:"none"}}>Number must be between 10 and 128</div>
                                </div>
                            </div>
